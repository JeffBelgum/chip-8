...
impl fmt::Display for OpCode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            OpCode::JpConst{nnn} =>      write!(f, "jump {:#03X}", nnn),
            OpCode::Call{nnn} =>         write!(f, "call {:#03X}", nnn),
            OpCode::SkpEqConst{x,nn} =>  write!(f, "skip V{:X}=={:#02X}", x, nn),
            OpCode::SkpNeConst{x,nn} =>  write!(f, "skip V{:X}!={:#02X}", x, nn),
            OpCode::SkpEqReg{x,y} =>     write!(f, "skip V{:X}==V{:X}", x, y),
            OpCode::SetConst{x,nn} =>    write!(f, "set  V{:X}={:#02X}", x, nn),
            OpCode::AddConst{x,nn} =>    write!(f, "set  V{:X}+={:#02X}", x, nn),
            ...
            OpCode::SetI{nnn} =>         write!(f, "set  I={:#03X}", nnn),
            OpCode::JpOffset{nnn} =>     write!(f, "jump V0 + {:#03X}", nnn),
